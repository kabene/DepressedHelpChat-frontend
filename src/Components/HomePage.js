    ...
    var CookieBanner = function () {
        function e() {
            _classCallCheck(this, e),
                ...
                this.closeBtn = document.querySelector(".gdpr--cookie-close"),
                this.allowBtn = document.querySelector(".gdpr--cookie-accept"),
                this.declineBtn = document.querySelector(".gdpr--cookie-decline"),
                this.getCookie("cookies_allowed") || this.root.classList.remove("hidden", "gone"),
                this.closeBanner = this.closeBanner.bind(this),
                this.allowCookies = this.allowCookies.bind(this),
                this.disableCookies = this.disableCookies.bind(this),
                this.closeBtn.addEventListener("click", this.closeBanner, !1),
                this.allowBtn.addEventListener("click", this.allowCookies, !1),
                this.declineBtn.addEventListener("click", this.disableCookies, !1)
        }
